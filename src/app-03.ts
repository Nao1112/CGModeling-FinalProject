...
class ThreeJSContainer {
    ...
    private createScene = () => {
        ...
        const texture = textureLoader.load('src/kadai03.jpg');
        ...
        //物理現象に即し、反射し光沢がある
        matArray.push(new THREE.MeshStandardMaterial({ color: 0x55ff00 ,metalness: 0.2,roughness: 0.2}));
        //メッシュ
        matArray.push(new THREE.MeshBasicMaterial({ color: 0x55ff00 ,wireframe: true}));
        //光沢のある
        matArray.push(new THREE.MeshPhongMaterial({ color: 0x55ff00 ,specular: 0xff0000}));
...
function init() {
    ...
    const viewport = container.createRendererDOM(640, 480, new THREE.Vector3(-8, 8, 8));
